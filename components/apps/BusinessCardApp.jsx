...
// PERFECTED REACT SVG FOR SELLOUT CROWDS
            ...
            .then(data => {
                if (data.card) {
                    ...
                    if (!fetchedCard.links) {
                        ...
                        // Ensure existing users get the new links seamlessly
                    ...
                    // Force the title to update to 'Official Shop' for old saves
