                            ...
                            <p className="text-xs text-gray-500 mt-auto pt-4 flex items-center justify-between">
                                ...
                                {isAdmin && (
                                    <span className="flex items-center gap-2">
                                        <button onClick={(e) => { e.stopPropagation(); setEditingGuide({...guide, content: JSON.parse(guide.content)}); setShowModal(true); }} className="text-gray-500 hover:text-white transition-colors p-1"><Pencil size={14}/></button>
