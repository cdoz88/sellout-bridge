...
import { Save, Loader2, Share2, QrCode, Link2, MonitorSmartphone, UploadCloud, X, Palette, Image as ImageIcon, Phone, Mail, Globe, Linkedin, Facebook, Youtube, Instagram, ArrowRight, Type, Megaphone, GripVertical, Trash2, Plus, ShoppingBag, Podcast } from 'lucide-react';
...
const SelloutIcon = ({ size=20, className="" }) => (
    <svg width={size} height={size} viewBox="0 0 362.85 305.65" fill="none" className={className}>
        <g>
            ...
            <path d="m99.19,298.5c-.15.06-.41.09-.72.12.07-.08.47-.17.72-.12Z" fill="currentColor" fillRule="evenodd" />
            <path d="m87.32,290.56c-.22.06-.91.2-.85.04.39-.05.56-.03.85-.04Z" fill="currentColor" fillRule="evenodd" />
            <path d="m86.1,290.47c-.05.08-.6.06-.85.11,0-.09.69-.14.85-.11Z" fill="currentColor" fillRule="evenodd" />
            <path d="m82.83,292.15c-.17.06-.63.15-.85.11.05-.08.6-.06.85-.11Z" fill="currentColor" fillRule="evenodd" />
            <path d="m81.14,290.86c-.28.11-.78.19-1.45.23.23-.12.93-.17,1.45-.23Z" fill="currentColor" fillRule="evenodd" />
            <path d="m77.63,298.32c-.74.08-2.23.36-2.77.27.91,0,1.93-.26,2.77-.27Z" fill="currentColor" fillRule="evenodd" />
            <path d="m75.33,295.45c-.9.28-2.58.24-3.74.49-.18-.14,1.73-.2,2.05-.36.28-.02.5,0,.72,0,.33-.05.62-.18.97-.13Z" fill="currentColor" fillRule="evenodd" />
            <path d="m63.97,296.18c.03.08-.04.14-.36.17-.09-.02-.13-.06-.12-.12l.48-.05Z" fill="currentColor" fillRule="evenodd" />
            <path d="m59.4,297.8c-.73.23-2.43.42-3.38.43-.12.04-.12.09-.36.11-.56.09-1.82.18-.6.04,1.49-.29,2.69-.32,4.34-.57Z" fill="currentColor" fillRule="evenodd" />
            <path d="m58.65,296.25c-.17.07-.47.12-.84.15.08-.09.7-.17.84-.15Z" fill="currentColor" fillRule="evenodd" />
            <path d="m58,300.59c-.13.09-.76.09-1.08.15.23-.07.81-.19,1.08-.15Z" fill="currentColor" fillRule="evenodd" />
            <path d="m57.82,296.9c-.29.12-.96.17-1.32.27-.34-.09.87-.21,1.32-.27Z" fill="currentColor" fillRule="evenodd" />
            <path d="m57.21,296.5c-.23.12-.93.18-1.45.26.3-.11.98-.18,1.45-.26Z" fill="currentColor" fillRule="evenodd" />
            <path d="m56.93,301.49c-.03.11-.5.16-.84.23.06-.11.55-.15.84-.23Z" fill="currentColor" fillRule="evenodd" />
            <path d="m56.31,300.78c-.38.14-1.73.27-2.4.34.84-.18,1.48-.25,2.4-.34Z" fill="currentColor" fillRule="evenodd" />
            <path d="m55.52,296.79c-.6.22-1.53.22-2.05.26.56-.15,1.41-.1,2.05-.26Z" fill="currentColor" fillRule="evenodd" />
            <path d="m54.1,298.48c-.23.08-.63.14-.96.21-.08-.13.56-.15.96-.21Z" fill="currentColor" fillRule="evenodd" />
            <path d="m53.01,298.28c-.28.11-.54.11-.96.14.09-.08.68-.09.96-.14Z" fill="currentColor" fillRule="evenodd" />
            <path d="m51.92,298.01c-.12.1-1.03.23-.85.03.26-.04.23.02.24.07.29-.02.26-.09.6-.1Z" fill="currentColor" fillRule="evenodd" />
            <path d="m49.68,300.78c.58-.2,1.62-.13,0,0h0Z" fill="currentColor" fillRule="evenodd" />
            <path d="m48.51,302.12c-.49.13-.97.17-1.56.22.36-.09,1.31-.22,1.56-.22Z" fill="currentColor" fillRule="evenodd" />
            <path d="m48.16,302.36c.19.08-.78.19-.6.07l.6-.07Z" fill="currentColor" fillRule="evenodd" />
            <path d="m47.25,304.2c-.16.09-.54.15-.83.17.08-.09.69-.18.83-.17Z" fill="currentColor" fillRule="evenodd" />
            <path d="m43.91,304.48c-.96.28-1.33.17,0,0h0Z" fill="currentColor" fillRule="evenodd" />
            <path d="m70.89,301.38c-.2.06-.47.11-.6.19-.39-.09-1.05.09-1.56.09.6-.21,1.28-.09,2.17-.27Z" fill="currentColor" fillRule="evenodd" />
            <path d="m57.14,300.1c-.29.05-.26-.03-.6.04-.04-.05.11-.07.12-.11-.6.05-.93.14-1.44.2.06-.03.12-.07.12-.11-.66.25-1.48.08-2.89.33,1.33-.34,4.35-.58,5.53-.75-.16.14-1.21.15-1.32.31-.02.1.67-.06.48.11Z" fill="currentColor" fillRule="evenodd" />
