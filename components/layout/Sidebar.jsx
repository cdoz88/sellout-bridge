    ...
    return (
        <div className="w-64 bg-[#0a0a0a] border-r border-white/5 flex flex-col h-full shadow-xl flex-shrink-0 z-40 relative pb-16 lg:pb-0">
            ...
            <div className="flex-1 overflow-y-auto pt-6 pb-2 custom-scrollbar flex flex-col">
                ...
                {currentApp === 'affiliate' && (
                    <div className="px-4 flex flex-col flex-1 h-full min-h-full">
                        <div>
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 px-2">Menu</p>
                            <div className="space-y-1">
                                <button onClick={() => handleNavClick('dashboard')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'dashboard' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <TrendingUp size={16} /> Scouting Dashboard
                                </button>
                    ...
                    <div className="px-4 flex flex-col flex-1 h-full min-h-full">
                        <div>
                            ...
                            <div className="space-y-1">
                                ...
                                <button onClick={() => { handleNavClick('compose'); window.dispatchEvent(new CustomEvent('new-newsletter-draft')); }} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'compose' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <PenTool size={16} /> New Draft
                                </button>
                                <button onClick={() => handleNavClick('audience')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'audience' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <Users size={16} /> Audience Lists
                                </button>
                                <button onClick={() => handleNavClick('settings')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'settings' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <Settings size={16} /> Sender Profile
                                </button>
                                <button onClick={() => handleNavClick('footer')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'footer' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <LayoutTemplate size={16} /> Footer Design
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                {currentApp === 'teammates' && (
                    <div className="px-4 flex flex-col flex-1 h-full min-h-full">
                        <div>
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3 px-2">Menu</p>
                            <div className="space-y-1">
                                <button onClick={() => handleNavClick('directory')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'directory' || (!activeTab) ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <AddressBook size={16} /> Team Directory
                                </button>
                                {!isTeammate && (
                                    <button onClick={() => handleNavClick('manage')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'manage' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                    ...
                    <div className="px-4 flex flex-col flex-1 h-full min-h-full">
                        <div>
                            ...
                            <div className="space-y-1">
                                ...
                                <button onClick={() => handleNavClick('auto_joins')} className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl font-black uppercase text-[10px] tracking-widest transition-colors ${activeTab === 'auto_joins' ? 'bg-[#9df01c] text-black shadow-lg shadow-[#9df01c]/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}>
                                    <Users size={16} /> Auto-Joins
                                </button>
                            </div>
                        </div>
                    </div>
